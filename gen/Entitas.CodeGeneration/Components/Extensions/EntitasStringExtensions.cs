...
{
    public const string ContentSuffix = "Context";
    ...
    public static string AddContextSuffix(this string str) => AddSuffix(str, ContentSuffix);
    public static string RemoveContextSuffix(this string str) => RemoveSuffix(str, ContentSuffix);
    public static bool HasContextSuffix(this string str) => HasSuffix(str, ContentSuffix);
