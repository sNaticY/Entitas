namespace Entitas
{
    ...
    /// Mandatory attributes from Entitas.CodeGeneration.Attributes:
    /// [Main]: Use a context marker attribute to make this component available
    ...
    /// More available attributes can be found in Entitas.CodeGeneration.Attributes.
